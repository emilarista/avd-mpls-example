...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet49/1 | P2P_LINK_TO_PE-01_Ethernet2/1 | routed | - | 100.64.48.17/31 | default | 1500 | false | - | - |
...
| --------- | ------------- | ------------- | ----------- | ---- | ----------------- |
| Ethernet49/1 | - | MPLS_UNDERLAY | 50 | point-to-point | level-1-2 |
...
| Interface | ISIS Instance | ISIS Metric | Interface Mode |
| --------- | ------------- | ----------- | -------------- |
| Ethernet49/1 | MPLS_UNDERLAY | 50 | point-to-point |
