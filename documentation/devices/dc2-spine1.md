...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.30.30.119/24 | 10.30.30.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-BORDERLEAF1_Ethernet1 | routed | - | 100.64.20.0/31 | default | 9214 | false | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SERVERLEAF1_Ethernet1 | routed | - | 100.64.20.6/31 | default | 9214 | false | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC2-BORDERLEAF1_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC2-SERVERLEAF1_Ethernet1
   no shutdown
   mtu 9214
   no switchport
   ip address 100.64.20.6/31
```
...
| -------- | --------- | --- |
| 100.64.20.1 | 65000.210 | default |
| 100.64.20.7 | 65000.211 | default |
...
router bgp 65000.200
   ...
   neighbor 100.64.20.1 remote-as 65000.210
   neighbor 100.64.20.1 description dc2-borderleaf1_Ethernet1
   neighbor 100.64.20.7 peer group IPv4-UNDERLAY-PEERS
   neighbor 100.64.20.7 remote-as 65000.211
   neighbor 100.64.20.7 description dc2-serverleaf1_Ethernet1
