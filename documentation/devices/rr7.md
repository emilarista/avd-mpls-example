...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_PE3_Ethernet3 | routed | - | unnumbered Loopback0 | default | 1600 | false | - | - |
| Ethernet2 | P2P_LINK_TO_PE1_Ethernet3 | routed | - | unnumbered Loopback0 | default | 1600 | false | - | - |
| Ethernet3 | P2P_LINK_TO_PE5_Ethernet3 | routed | - | unnumbered Loopback0 | default | 1600 | false | - | - |
| Ethernet4 | P2P_LINK_TO_P4_Ethernet3 | routed | - | unnumbered Loopback0 | default | 1600 | false | - | - |

#### IPv6

| Interface | Description | Type | Channel Group | IPv6 Address | VRF | MTU | Shutdown | ND RA Disabled | Managed Config Flag | IPv6 ACL In | IPv6 ACL Out |
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet1 | P2P_LINK_TO_PE3_Ethernet3 | routed | - | - | default | 1600 | false | - | *- | - | - |
| Ethernet2 | P2P_LINK_TO_PE1_Ethernet3 | routed | - | - | default | 1600 | false | - | *- | - | - |
| Ethernet3 | P2P_LINK_TO_PE5_Ethernet3 | routed | - | - | default | 1600 | false | - | *- | - | - |
| Ethernet4 | P2P_LINK_TO_P4_Ethernet3 | routed | - | - | default | 1600 | false | - | *- | - | - |
...
| Ethernet4 | - | MPLS_UNDERLAY | 50 | point-to-point |
...
| Net-ID | 49.0001.0000.0000.0007.00 |
| Type | level-2 |
...
| -------- | --------- | --- |
| 100.70.0.1 | Inherited from peer group MPLS-OVERLAY-PEERS | default |
| 100.70.0.2 | Inherited from peer group MPLS-OVERLAY-PEERS | default |
| 100.70.0.3 | Inherited from peer group MPLS-OVERLAY-PEERS | default |
| 100.70.0.5 | Inherited from peer group MPLS-OVERLAY-PEERS | default |
